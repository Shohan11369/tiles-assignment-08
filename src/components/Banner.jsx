...
const Banner = () => {
  return (
    <div className="bg-[url('https://images.unsplash.com/photo-1600607687939-ce8a6c25118c')] h-[60vh] w-full bg-cover bg-no-repeat bg-center flex items-center rounded-lg shadow-2xl">
      {/* Overlay */}
