...
const Banner = () => {
  return (
    <div className="bg-[url('https://images.unsplash.com/photo-1600585154340-be6161a56a0c')] h-[60vh] w-full bg-cover bg-no-repeat bg-center flex items-center rounded-lg shadow-2xl">
      {/* Overlay */}
